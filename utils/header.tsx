import { mainComponentProps, profileComponentProps } from '@/types/header';
    ...
    return [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    sub_children: [
                        ...
                        },
                        {
                            ...
                            svg: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-flag"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/></svg>,
                        },
                        {
                ...
                {
                    sub_title: 'Школа', sub_href: '/diary/school/about',
                    sub_children: [
                        {
                            sub_title: 'Кружки',
...
export { profileInfo, mainInfo, getCurrentPageName, defineUserRole, profileInfoMb };