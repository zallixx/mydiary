...
export default function SchedulePageClient() {
    ...
    return (
        <div className="min-h-screen flex items-start max-2xm:pt-16 2xm:pt-8 justify-center">
            <section className="static left-1/2 right-1/2 3xl:w-[1400px] 2xl:w-[1000px] flex flex-col transition duration-500 max-lg:w-[95%] ease-in-out">
                ...
                <div className="min-h-96 h-auto pt-2 space-y-2 mb-28">
                    {loading && (
                        <div>
